...
if (!require(ggplot2, quietly = TRUE)) {
  suppressMessages(install.packages("ggplot2", repos = "https://cran.rstudio.com/", quiet = TRUE))
  library(ggplot2)
}
if (!require(broom, quietly = TRUE)) {
  suppressMessages(install.packages("broom", repos = "https://cran.rstudio.com/", quiet = TRUE))
  library(broom)
}
