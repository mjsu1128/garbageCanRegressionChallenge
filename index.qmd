...
I chose to split the data into low-stress and high-stress subsets because StressSurvey behaves differently across those ranges. At low levels it scales cleanly as about three times Stress, making it a good proxy. However, at higher levels the survey flattens and no longer tracks Stress proportionally, which distorts the regression. Splitting the sample this way helps reveal where the proxy works and where it breaks down.
