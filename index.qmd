...
---
The data was split into low-stress and high-stress subsets because StressSurvey behaves differently across those ranges. At low levels it scales cleanly as about three times Stress, making it a reliable proxy. At higher levels the survey flattens and no longer tracks Stress proportionally, which distorts the regression. Splitting the sample this way helps reveal where the proxy works and where it breaks down.
---
